...
class Predictor(BasePredictor):
    ...
    def predict(
        self,
        prompt: str = Input(
            description="Input prompt. Use the word \"emoji\" somewhere in the prompt.", default=""),
        negative_prompt: str = Input(
            description="The prompt NOT to guide the image generation. Ignored when not using guidance", default=None),
        width: int = Input(
